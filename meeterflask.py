...
def index():
    ...
    if request.method == 'POST':
    	...
    	template_context = dict(title=title, address=address, metro=metro, time=time, url=url, menu=menu, information=information, a=a, b=b, espresso=espresso, cappucino=cappucino)
